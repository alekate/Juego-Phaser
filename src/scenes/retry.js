...
export class retry extends Phaser.Scene {
    ...
    create() {
        this.add
          .image(this.cameras.main.centerX, this.cameras.main.centerY, "Fondo_Over") //buscar pantalla retry y poner ak cargar con la key.
          .setScale(1.1);
    
        this.add.image(
          this.cameras.main.centerX,
          this.cameras.main.centerY / 1.5,
          "gameover_logo" //hacer logo de game over mismo que fondo
        )
        .setScale(1.1);
